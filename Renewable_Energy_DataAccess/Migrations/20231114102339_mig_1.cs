    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_References_ReferenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectBlogRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectBlogRelations_Blogs_BlogId",
                        column: x => x.BlogId,
                        principalTable: "Blogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectBlogRelations_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectBlogRelations_BlogId",
                table: "ProjectBlogRelations",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectBlogRelations_ProjectId",
                table: "ProjectBlogRelations",
                column: "ProjectId");
